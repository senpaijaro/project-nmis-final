       <?php extract($showrequest);?>
        ...
        <div class="right_col" role="main">
          <div class="">
          <h5 class="pull-right"><i class="fa fa-dashboard"></i><a href="<?php echo base_url()?>Dashboard"> Dashboard</a> <i class="fa fa-arrow-right"></i><a class="active"><a href="<?php echo base_url()?>Showcompleted"> Completed</a><a class="active"> <i class="fa fa-arrow-right"></i> View Completed</h5></a>
            <div class="row">
                  ...
                  <div class="x_content">
                   ...
                   <div class="col-md-5">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" readonly style="resize:none;height:68px;"  placeholder="None"></textarea>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" readonly style="resize:none;"  placeholder="None" ><?php echo $action_reason?></textarea>
                     </div>
                      <div class="form-group">
                        <label>Name</label>
                        <input class="form-control" placeholder="Input your name before update this status" required="required" readonly value="<?php echo $updated_by?>">
                        <br>
